        ...
        <div className="container-fluid ">
            ...
            <div className="row">
                ...
                <div className="col-md-6 text-center all_words">
                    ...
                    <div style={{
                        width: `${diameter}px`, height: `${diameter}px`, backgroundSize: `${diameter}px ${diameter}px`,
                        marginLeft: 'auto', marginRight: 'auto', marginTop: '100px', fill: 'white'
                    }}>
