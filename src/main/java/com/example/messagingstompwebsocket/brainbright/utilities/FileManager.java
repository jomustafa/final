...
public class FileManager {
    ...
    private List<String> countries_gr, countries_en, sortedDictionary_gr, sortedDictionary_en, splitEasy_en,splitEasy_gr, simpleShort_en,simpleShort_gr,
            animalList_gr, animalList_en, plantList_gr, plantList_en, occupationList_gr, occupationList_en, countryList_gr, countryList_en, nameList_gr, nameList_en, simpleDict_gr, simpleDict_en, faces, houses,
        femaleNames_gr, femaleNames_en, maleNames_gr, maleNames_en, faces2, facesSituations, situations, sayingsList_gr, sayingsList_en, anagramList_gr,anagramList_en, hangmanPlants_gr, hangmanPlants_en, hangmanAnimals_gr, hangmanAnimals_en, hangmanOccupations_gr, hangmanOccupations_en, spotdifferences;
...
//    }
    ...
    public List<String> getDifferences(){return spotdifferences; }
